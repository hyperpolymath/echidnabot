...
:url-gitlab: https://gitlab.com/hyperpolymath/echidnabot
:url-bitbucket: https://bitbucket.org/hyperpolymath/echidnabot
:url-codeberg: https://codeberg.org/hyperpolymath/echidnabot
...
echidnabot is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
