...
This historical carve-out is inactive: it was superseded and its sunset
fulfilled on 2026-04-25. MCP integrations must now go through BoJ.
See `.machine_readable/descriptiles/AGENTIC.a2ml` `[exceptions.boj-only-mcp]`
