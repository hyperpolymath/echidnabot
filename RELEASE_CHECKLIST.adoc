...
deployment automation; see link:ROADMAP.adoc[`+ROADMAP.adoc+`]
"`Remaining Work`").
...
* [x] docs/content/\{index,getting-started,configuration,api}.md
(casket-ssg)

==== To Add

* [ ] docs/DEPLOYMENT.md — Production deployment guide (k8s, helm,
docker-compose)
...
* [x] 12-prover surface (Coq, Lean 4, Agda, Isabelle, Z3, CVC5,
...
(Guix flake intentionally NOT planned: guix is deprecated estate-wide as
of 2026-06-01.)
