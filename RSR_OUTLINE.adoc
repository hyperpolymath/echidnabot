...
│   ├── descriptiles/          # STATE / META / AGENTIC / ECOSYSTEM / etc.
│   │   └── anchor/            # Supporting anchor descriptors
...
├── guix.scm                   # Guix package definition (primary; guix deprecated 2026-06-01)
...
Guix is **deprecated estate-wide** as of 2026-06-01 — Guix is the sole
primary; guix flakes have been removed and are not a Tier 2 acceptable
language any more.
...
|`.machine_readable/descriptiles/` |✓ |A2ML descriptors
|===

== STATE.a2ml Shape

The canonical project-state file
(`.machine_readable/descriptiles/STATE.a2ml`) carries:
