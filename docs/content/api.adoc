...
Register a new repository for proof verification. This example omits the
optional webhook secret; configure a secret from your credential store before
accepting authenticated webhook events.
